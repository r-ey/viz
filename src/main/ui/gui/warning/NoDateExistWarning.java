...
// Create warning page
public class NoDateExistWarning extends JFrame {

    private final CustomFont customFont;
    private JLayeredPane pane;
    private int backgroundLayer;

    public NoDateExistWarning() {
    ...
    private void setFrame() {
        ...
        setTitle("No Date Exists Warning");
    ...
    private void setText() {
        JLabel text = new JLabel("Date is invalid");
    ...
    private void setShape() {
        Triangle triangle = new Triangle(RelativeTo.relativeToWidth(0.151), RelativeTo.relativeToHeight(0.01),
                RelativeTo.relativeToWidth(0.157), RelativeTo.relativeToHeight(0.01),
                RelativeTo.relativeToWidth(0.154), RelativeTo.relativeToHeight(0.028),
        ...
        Circle circle = new Circle(RelativeTo.relativeToWidth(0.1517), RelativeTo.relativeToHeight(0.033),
