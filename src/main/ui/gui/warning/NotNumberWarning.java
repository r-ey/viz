...
// Create warning page
public class NotNumberWarning extends JFrame {
    ...
    public NotNumberWarning(String s) {
    ...
    private void setText() {
        JLabel text = new JLabel(component + " must be numbers");
