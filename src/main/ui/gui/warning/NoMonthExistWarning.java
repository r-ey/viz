...
// Create warning page
public class NoMonthExistWarning extends JFrame {

    private final CustomFont customFont;
    private JLayeredPane pane;
    private int backgroundLayer;

    public NoMonthExistWarning() {
    ...
    private void setFrame() {
        ...
        setTitle("No Month Exists Warning");
    ...
    private void setText() {
        JLabel text = new JLabel("Month is invalid");
        ...
        text.setLocation(RelativeTo.relativeToWidth(0.17), RelativeTo.relativeToHeight(-0.08));
    ...
    private void setShape() {
        Triangle triangle = new Triangle(RelativeTo.relativeToWidth(0.156), RelativeTo.relativeToHeight(0.01),
                RelativeTo.relativeToWidth(0.162), RelativeTo.relativeToHeight(0.01),
                RelativeTo.relativeToWidth(0.159), RelativeTo.relativeToHeight(0.028),
        ...
        Circle circle = new Circle(RelativeTo.relativeToWidth(0.1567), RelativeTo.relativeToHeight(0.033),
