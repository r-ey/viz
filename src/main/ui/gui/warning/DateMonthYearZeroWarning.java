...
// Create warning page
public class DateMonthYearZeroWarning extends JFrame {

    private final CustomFont customFont;
    private JLayeredPane pane;
    private int backgroundLayer;

    public DateMonthYearZeroWarning() {
    ...
    private void setFrame() {
        ...
        setTitle("Date Month Year Zero Warning");
    ...
    private void setText() {
        JLabel text = new JLabel("Date, month, or year can't be zero");
        ...
        text.setLocation(RelativeTo.relativeToWidth(0.14), RelativeTo.relativeToHeight(-0.08));
    ...
    private void setShape() {
        Triangle triangle = new Triangle(RelativeTo.relativeToWidth(0.132), RelativeTo.relativeToHeight(0.01),
                RelativeTo.relativeToWidth(0.125), RelativeTo.relativeToHeight(0.01),
                RelativeTo.relativeToWidth(0.129), RelativeTo.relativeToHeight(0.028),
        ...
        Circle circle = new Circle(RelativeTo.relativeToWidth(0.1271), RelativeTo.relativeToHeight(0.033),
