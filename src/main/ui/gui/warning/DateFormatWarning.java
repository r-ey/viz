...
// Create warning page
public class DateFormatWarning extends JFrame {

    private final CustomFont customFont;
    private JLayeredPane pane;
    private int backgroundLayer;

    public DateFormatWarning() {
    ...
    private void setText() {
        JLabel text = new JLabel("Format must be YYYY-MM-DD");
    ...
    private void setShape() {
        Triangle triangle = new Triangle(RelativeTo.relativeToWidth(0.131), RelativeTo.relativeToHeight(0.01),
                RelativeTo.relativeToWidth(0.137), RelativeTo.relativeToHeight(0.01),
                RelativeTo.relativeToWidth(0.134), RelativeTo.relativeToHeight(0.028),
        ...
        Circle circle = new Circle(RelativeTo.relativeToWidth(0.1317), RelativeTo.relativeToHeight(0.033),
