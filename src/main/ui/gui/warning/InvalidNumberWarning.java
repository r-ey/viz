...
// Create warning page
public class InvalidNumberWarning extends JFrame {
    ...
    public InvalidNumberWarning(String s) {
    ...
    private void setFrame() {
        ...
        setTitle("Invalid Number Warning");
    ...
    private void setText() {
        JLabel text = new JLabel(component + " contains invalid number");
        ...
        text.setLocation(RelativeTo.relativeToWidth(0.15), RelativeTo.relativeToHeight(-0.08));
    ...
    private void setShape() {
        Triangle triangle = new Triangle(RelativeTo.relativeToWidth(0.136), RelativeTo.relativeToHeight(0.01),
                RelativeTo.relativeToWidth(0.142), RelativeTo.relativeToHeight(0.01),
                RelativeTo.relativeToWidth(0.139), RelativeTo.relativeToHeight(0.028),
        ...
        Circle circle = new Circle(RelativeTo.relativeToWidth(0.137), RelativeTo.relativeToHeight(0.033),
