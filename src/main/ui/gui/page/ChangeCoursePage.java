...
// create page to change course
public class ChangeCoursePage extends JFrame {
    ...
    public ChangeCoursePage(int t, MainPage m) {
    ...
    private void setCourses(MainPage m) {
        ...
        setButton(m, size, panel, courseList);
    ...
    // MODIFIES : this
    // EFFECTS : set button
    private void setButton(MainPage m, int size, JPanel panel, SimpleList<Course> courseList) {
